...
export default class EditItem extends React.Component<EditItemProps, EditItemState> {
            ...
            <div className="content-body flex-center">
                    ...
                    <Form className="item-content height bold">
                        <Group>
                            ...
                            <Input size="lg" type="text" placeholder={this.state.items[0].name} disabled={true}/>
                        </Group>
                        ...
                        <Group>
                            ...
                            <InputGroup>
                                ...
                                <Input type="number" placeholder={this.state.items[0].price} disabled={true}/>
                            </InputGroup>
                        </Group>

                        <Group>
                            <Label>Item Description:</Label>
                            <Input as="textarea" rows="3" placeholder={this.state.items[0].desc} disabled={true}/>
                        </Group>
                        <ButtonGroup>
