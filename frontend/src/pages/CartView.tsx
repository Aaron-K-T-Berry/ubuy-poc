...
<Row>
  ...
  <Form.Group>
        ...
        <Col>
            <div className="body-heading">{PageContent.checkoutPage.checkout_payment_label}</div>
        <div>
  <input type="radio" name="exampleRadios" id="credit" value="option1" checked></input>
  <label>
   Credit Card
  </label>
</div>
<div>
  <input  type="radio" name="exampleRadios" id="debit" value="option2"></input>
  <label>
    Debit Card
  </label>
</div>
<div>
  <input  type="radio" name="exampleRadios" id="paypal" value="option2"></input>
  <label>
    Paypal
  </label>
</div>
